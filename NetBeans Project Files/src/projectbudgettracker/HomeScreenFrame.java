...
public class HomeScreenFrame extends javax.swing.JFrame {
    ...
    public HomeScreenFrame(LoginFrame lfObj, String userName)
    {
        this();
        this.lfObj= lfObj;   
        ...
        userTransactionList = user.getUserTransactions();    
    ...
    {
        String col[] = {"Category","Description","Date", "Amount"};
        ...
        {
            Object[] objs = {userTransactionList.get(i).category,
                             userTransactionList.get(i).description,
                             userTransactionList.get(i).date,
                             userTransactionList.get(i).amount};
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Spending By Category", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ImportCSVFrame ifFrame = new ImportCSVFrame(this);
